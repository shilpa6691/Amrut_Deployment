...
# Default values
DEFAULT_VALUES = {
"DEFAULT_TEST_SIZE" : 12, #2, #8,
"DEFAULT_VALIDATION_SIZE" : 4 #2 #12
}
...
# 'processed_data_csv_file_name':f'{subsystem_name}/SIAP_DAG_{subsystem_name.upper()}_ES_cleaned_data.csv',
'processed_data_csv_file_name':f'{subsystem_name}/ES_demo_cleaned_data.csv',
...
'location_data_csv_file_name':'ES_PCMC_Location.csv'

}

JSON_FILE_PATH = {
    "upload_file_path":"/opt/siap/data/results/es_demo/",
    "forecasting_file_path":"/opt/siap/data/results/es_demo/tsa/"}
